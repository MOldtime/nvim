...
vim.o.guifont = "monospace,"
  ...
  .. ":h14:#e-subpixelantialias:#h-full"
...
for key, value in pairs {
  ...
  neovide_scroll_animation_far_lines = 9999, -- 远距离滚动的行数
  ...
  neovide_progress_bar_height = 5.0,
  neovide_progress_bar_animation_speed = 200.0,
  neovide_progress_bar_hide_delay = 0.2,

  neovide_text_gamma = 0.0,
  neovide_text_contrast = 0.5,
  neovide_pixel_geometry = "RGBH",
} do
  vim.g[key] = value
end
